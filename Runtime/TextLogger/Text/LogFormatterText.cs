...
namespace Unity.Logging
{
    ...
    public static class LogFormatterText
    {
        ...
        /// <param name="formatterStruct"></param>
        ...
        // Function that is used to parse message template, that can contain {Message}
        public static bool WriteTemplatedMessage(ref FixedString512Bytes template, in LogMessage messageData, ref FormatterStruct formatter, ref HeaderData headerData, ref UnsafeText messageOutput, ref FixedString512Bytes errorMessage, ref LogMemoryManager memAllocator)
        {
            unsafe
            {
        ...
        // Function that is used to parse the {Message} itself
